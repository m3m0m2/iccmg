...
full_keymap = {
  ...
  "KEY_DELETE": "DELETE",
  "KEY_MACRO": "MACRO",
  #"['KEY_MIN_INTERESTING', 'KEY_MUTE']": "['KEY_MIN_INTERESTING', 'KEY_MUTE']",
  "KEY_MUTE": "KEY_MUTE",
  ...
  "KEY_SCALE": "SCALE",
  "KEY_KPCOMMA": "KPCOMMA",
  #"['KEY_HANGEUL', 'KEY_HANGUEL']": "['KEY_HANGEUL', 'KEY_HANGUEL']",
  "KEY_HANJA": "HANJA",
  "KEY_YEN": "YEN",
  ...
  "KEY_WWW": "WWW",
  "KEY_MSDOS": "MSDOS",
  #"['KEY_COFFEE', 'KEY_SCREENLOCK']": "['KEY_COFFEE', 'KEY_SCREENLOCK']",
  ...
  #"['KEY_BRIGHTNESS_AUTO', 'KEY_BRIGHTNESS_ZERO']": "['KEY_BRIGHTNESS_AUTO', 'KEY_BRIGHTNESS_ZERO']",
  "KEY_DISPLAY_OFF": "DISPLAY_OFF",
  #"['KEY_WIMAX', 'KEY_WWAN']": "['KEY_WIMAX', 'KEY_WWAN']",
  "KEY_RFKILL": "RFKILL",
  "KEY_MICMUTE": "MICMUTE",
  "KEY_OK": "OK",
  "KEY_SELECT": "SELECT",
  ...
  #"['KEY_BRIGHTNESS_TOGGLE', 'KEY_DISPLAYTOGGLE']": "['KEY_BRIGHTNESS_TOGGLE', 'KEY_DISPLAYTOGGLE']",
...
class KeyMap:
  def __init__(self):
    self._map = copy.deepcopy(default_keymap)

  def clear(self):
    self._map = {}

  # e.g. set(KEY_PAUSE, KEY_ESC) # pause button sends esc command or
  # e.g. set(KEY_PAUSE, "p")     # pause button sends p string
  def setKey(self, key, value):
    if value in default_keymap:
      self._map[key] = default_keymap[value]
    else:
      self._map[key] = value
